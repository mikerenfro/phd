...
\begin{figure}
\centering
\includegraphics[width=0.5\columnwidth]{FAD-variance-n-modified}
...
\begin{figure}
\centering
\includegraphics[width=0.5\columnwidth]{FAD-variance-geometry-modified}
...
\begin{figure}
\centering
\includegraphics[width=0.6\columnwidth]{FAD-variance-aW-modified}
...
As seen in \Cref{tab:astm-analysis-requirements}, earlier standards can be completed with pocket calculators or simple spreadsheets, tools that are well within reach of any engineer or test facility, and the calculations are easily verified and checked by others.
\begin{table}[tbp]
