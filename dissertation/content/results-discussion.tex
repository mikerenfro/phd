...
The common practice in finite element modeling would be use a perfectly rigid contact surface, or a contact body with a stiffness several orders of magnitude larger than the local stiffness of the meshed model in the contact region.
